...
<div class="container body-header">
    <div class="row">
        <div class="col-md-9">
            <p>
                @ViewBag.Title / Add Family & Manage Members
...
<div class="container two-form">
    <div class="row">
        @Using Html.BeginForm("AddFamily", "Admin", FormMethod.Post, New With {.class = "form-horizontal form-bottom-space", .role = "form"})
        ...
        @<text>
                            ...
                            @For Each item In Model.FamilyMembers
                                @<tr>
                                    ...
                                    <td>
                                        ...
                                        data-Id="@item.UserId"
                                        data-Name="@item.Name"
                                        data-role="@item.Role">Add</button>
                                    </td>
                                </tr>
                            Next
                        </tbody>
            ...
            <div Class="col-md-6">
                <div class="row">
                    <div class="col-md-7">
                        <p class="instructions">Selected Users & Family Name</p>
                        @Html.ValidationSummary("", New With {.class = "text-danger"})
                    </div>
                </div>
                <div Class="body-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 padding-fix">
                            ...
                            <input type="submit" class="btn btn-primary btn-block" value="Create Family" />
                        </div>
                    </div>

                    <div class="form-inputs" style="display:none;"></div>
                </div>
            </div>
