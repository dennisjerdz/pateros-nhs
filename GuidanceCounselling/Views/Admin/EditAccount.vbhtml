...
<div class="container body-header">
    <div class="row">
        <div class="col-md-9">
            ...
            <a class="header-btn btn btn-default" href="@Url.Action("Accounts")"><span class="glyphicon glyphicon-chevron-left"></span>Back</a>
        </p>
    </div>
</div>
</div>
...
<div class="container body-data">
    @Using Html.BeginForm("EditAccount", "Admin", FormMethod.Post, New With {.class = "form-horizontal form-bottom-space", .role = "form"})
