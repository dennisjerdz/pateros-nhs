@ModelType GuidanceCounselling.QuestionOneToFive
@Code
...
<div class="container body-header">
    <div class="row">
        <div class="col-md-9">
            <p>
                @ViewBag.Title / @Model.QuestionGroupId / Rank 1 to 5 Questions / @Model.QuestionOneToFiveId / Edit
...
<div class="container body-data">
    @Using Html.BeginForm("EditOneToFive", "GuidanceCounselor", FormMethod.Post, New With {.class = "form-horizontal form-bottom-space", .role = "form"})

        @Html.AntiForgeryToken()
        @Html.HiddenFor(Function(m) m.QuestionOneToFiveId, New With {.Value = Model.QuestionOneToFiveId})
