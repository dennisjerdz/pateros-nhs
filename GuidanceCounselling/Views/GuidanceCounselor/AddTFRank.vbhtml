...
<div class="container body-header">
    <div class="row">
        <div class="col-md-9">
            <p>
                @ViewBag.Title / @ViewBag.QuestionGroupId / True or False (Ranked Results) Questions / Add
...
<div class="container body-data">
    @Using Html.BeginForm("AddTFRank", "GuidanceCounselor", FormMethod.Post, New With {.class = "form-horizontal form-bottom-space", .role = "form"})
