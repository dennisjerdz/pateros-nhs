@ModelType IEnumerable(Of GuidanceCounselling.QuestionOneToFive)
@Code
...
<div class="container body-header">
    <div class="row">
        <div class="col-md-9">
            <p>
                @ViewBag.Title / @ViewBag.Id / Rank 1 to 5 Questions
                ...
                <a class="header-btn btn btn-info" href="@Url.Action("AddOneToFive", New With {.id = ViewBag.Id})"><span class="glyphicon glyphicon-plus"></span>Add</a>
            </p>
        </div>
