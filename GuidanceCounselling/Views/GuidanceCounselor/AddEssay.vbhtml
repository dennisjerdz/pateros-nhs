...
<div class="container body-header">
    <div class="row">
        <div class="col-md-9">
            <p>
                @ViewBag.Title / @ViewBag.QuestionGroupId / Essay Questions / Add
...
<div class="container body-data">
    @Using Html.BeginForm("AddEssay", "GuidanceCounselor", FormMethod.Post, New With {.class = "form-horizontal form-bottom-space", .role = "form"})
