    ...
    <div class="row">
        <div class="col-md-9">
            <p>
                ...
                <a class="header-btn btn btn-info" href="@Url.Action("AddSubjectGrade", New With {.id = Model.StudentGradeId})"><span class="glyphicon glyphicon-plus"></span>Add</a>
            </p>
        </div>
                    ...
                    @For Each item In Model.SubjectGrades
                        @<tr>
                            ...
                            <td style="text-align:right;">
                                @Html.ActionLink("Edit Info", "EditSubjectGrade", New With {.id = item.SubjectGradeId}, New With {.class = "btn btn-xs btn-warning"})
                            </td>
                        </tr>
                    Next
                </tbody>
