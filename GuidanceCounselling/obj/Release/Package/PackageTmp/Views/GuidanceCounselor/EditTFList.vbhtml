@ModelType GuidanceCounselling.QuestionTFList
@Code
...
<div class="container body-header">
    <div class="row">
        <div class="col-md-9">
            <p>
                @ViewBag.Title / @Model.QuestionGroupId / True or False (List Results) Questions / @Model.QuestionTFListId / Edit
...
<div class="container body-data">
    @Using Html.BeginForm("EditTFList", "GuidanceCounselor", FormMethod.Post, New With {.class = "form-horizontal form-bottom-space", .role = "form"})

        @Html.AntiForgeryToken()
        @Html.HiddenFor(Function(m) m.QuestionTFListId, New With {.Value = Model.QuestionTFListId})
