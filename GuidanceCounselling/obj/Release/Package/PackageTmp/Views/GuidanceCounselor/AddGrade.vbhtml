...
<div class="container body-data">
    @Using Html.BeginForm("AddGrade", "GuidanceCounselor", FormMethod.Post, New With {.class = "form-horizontal form-bottom-space", .role = "form"})
        ...
        @<text>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <input type="submit" class="btn btn-primary btn-block" value="Add Grade/Grading" />
                </div>
            </div>
        </text> End Using
</div>