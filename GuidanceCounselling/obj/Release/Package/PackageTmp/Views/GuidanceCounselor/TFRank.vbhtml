@ModelType IEnumerable(Of GuidanceCounselling.QuestionTFRank)
@Code
...
<div class="container body-header">
    <div class="row">
        <div class="col-md-9">
            <p>
                @ViewBag.Title / @ViewBag.Id / True or False (Ranked Results) Questions
                ...
                <a class="header-btn btn btn-info" href="@Url.Action("AddTFRank", New With {.id = ViewBag.Id})"><span class="glyphicon glyphicon-plus"></span>Add</a>
            </p>
        </div>
