...
<div class="container body-header">
    <div class="row">
        <div class="col-md-9">
            <p>
                Grade / @Model.GradeId / @ViewBag.Title / Edit
...
<div class="container body-data">
    @Using Html.BeginForm("SectionsEdit", "Admin", FormMethod.Post, New With {.class = "form-horizontal form-bottom-space", .role = "form"})
