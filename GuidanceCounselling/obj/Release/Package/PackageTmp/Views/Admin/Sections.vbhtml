    ...
    <div class="row">
        <div class="col-md-9">
            <p>
                ...
                <a class="header-btn btn btn-default" href="@Url.Action("Grades")"><span class="glyphicon glyphicon-chevron-left"></span>Back to Grades List</a>
                <a class="header-btn btn btn-info" href="@Url.Action("SectionsAdd")"><span class="glyphicon glyphicon-plus"></span>Add</a>
            </p>
        </div>
