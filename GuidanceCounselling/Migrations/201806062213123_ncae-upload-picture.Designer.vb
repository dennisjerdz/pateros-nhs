...
Namespace Migrations
    ...
    Public NotInheritable Partial Class ncaeuploadpicture
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(ncaeuploadpicture))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201806062213123_ncae-upload-picture"
            End Get
        End Property
