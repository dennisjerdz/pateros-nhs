...
Namespace Migrations
    ...
    Public NotInheritable Partial Class checkifpending1
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(checkifpending1))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201801291543186_check-if-pending1"
            End Get
        End Property
